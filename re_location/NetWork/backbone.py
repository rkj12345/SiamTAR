...
from .NetWork_utils import MemoryEfficientSwish, Swish
from .model import Conv2dStaticSamePadding,MaxPool2dStaticSamePadding
from .efficientnet import MBConvBlock,EfficientNet
...
class EfficientNet_back(nn.Module):
    """
    modified by Zylo117
    """

    def __init__(self, compound_coef, load_weights=False):
        super(EfficientNet_back, self).__init__()
