...
__C.DATASET.GOT = CN()
__C.DATASET.GOT.ROOT = 'E:\\RGB_tracking_dataset\\train_dataset\\got10k\\crop511'         # GOT dataset path
__C.DATASET.GOT.ANNO = 'E:\\RGB_tracking_dataset\\train_dataset\\got10k\\train.json'
...
__C.DATASET.LaSOT.NUM_USE = 64000

__C.DATASET.VIDEOS_PER_EPOCH = 64000 #600000
# ------------------------------------------------------------------------ #
# Backbone options
# ------------------------------------------------------------------------ #
__C.BACKBONE = CN()
...
# __C.HP_SEARCH.VOT2018 = [0.730, 0.021, 0.321]
# __C.HP_SEARCH.VOT2018 = [0.584, 0.016, 0.501]
# __C.HP_SEARCH.VOT2018 = [0.33, 0.04, 0.44]

# __C.HP_SEARCH.VOT2018 = [0.320, 0.120, 0.450]

__C.HP_SEARCH.VOT2018 = [0.7, 0.04, 0.40]

#__C.HP_SEARCH.VOT2019 = [0.644, 0.06, 0.484]

__C.HP_SEARCH.VOT2019 = [0.854, 0.017, 0.438] #tune


__C.HP_SEARCH.DTB70 = [0.644, 0.06, 0.484]
