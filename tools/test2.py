...
parser.add_argument('--snapshot', type=str, default='../snapshot_r50/checkpoint_5data_e18.pth',
        help='snapshot_oral of models to eval')
parser.add_argument('--update_path', default='./updatenet/checkpoint/model_general.pth.tar', type=str, help='eval one special video')
...
def main():
    ...
    # create dataset
    dataset_root = 'E:\\RGB_tracking_dataset\\OTB100'
    ...
    for v_idx, video in enumerate(dataset):
        ...
        # model_path = os.path.join('D:\\codeProjects\\SiamCAR1-master-updateneting\\results', args.dataset, model_name)
