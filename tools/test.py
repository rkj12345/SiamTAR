...
parser.add_argument('--snapshot', type=str, default='../snapshot_r50/checkpoint_test_e3.pth',
...
def main():
    ...
    # create dataset
    dataset_root = 'E:\\BaiduNetdiskDownload\\VOT2018'
    ...
    for video in tqdm(dataset):
        ...
        for idx, (img, gt_bbox) in enumerate(video):
            ...
            if idx == frame_counter:
                ...
                #pred_bboxes.append(pred_bbox)
                overlap = poly_iou(pred_bbox, gt_bbox, (img.shape[1], img.shape[0]))#ddadasd
                if overlap>0:
                    pred_bboxes.append(pred_bbox)
                else:
                    #lost object
